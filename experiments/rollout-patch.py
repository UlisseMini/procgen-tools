...
# %% 
def patch_fn(venv, coeff: float, label: str, hook: cmh.ModuleHook, values: np.ndarray):
    """ Patch the model with a single patch of strength coeff """
    patch_layer(hook, values, coeff, label, venv)
